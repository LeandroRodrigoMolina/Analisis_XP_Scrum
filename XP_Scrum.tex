...
\begin{document}
	...
	\begin{figure}[h]
		...
		\caption{Tabla 1: Resultado obtenidos de análisis de la segunda dimensión. Fuente: Producción propia basado en los resultados obtenidos por \textcite{Gill_Henderson-Sellers_2006}.}
	...
	\begin{figure}[h]
		...
		\caption{Tabla 2: Tabla ventajas y desventajas de XP/Scrum. Fuente: producción propia}
